...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wpSeleccionAlumnosEmpresaUserControl.ascx.cs" Inherits="BIT.UDLA.FLUJO.PASANTIAS.WebParts.wpSeleccionAlumnosEmpresa.wpSeleccionAlumnosEmpresaUserControl" %>
<%@ Register src="../usrPager.ascx" tagname="usrPager" tagprefix="uc1" %>
 <h2>Selección de Estudiantes</h2>
<asp:GridView ID="grdPasantias" runat="server" AutoGenerateColumns="False" 
    ...
    <Columns>
        <asp:TemplateField HeaderText="Estudiante">
         ...
         <asp:TemplateField HeaderText="Carrera">
            ...
            <ItemTemplate>
                <asp:Label ID="Label3" runat="server" Text='<%# Eval("Carrera") %>'></asp:Label>
            </ItemTemplate>
        </asp:TemplateField>
