...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CancelarFlujo.aspx.cs" Inherits="BIT.UDLA.FLUJO.PASANTIAS.WebParts.Layouts.Dialogs.CancelarFlujo" DynamicMasterPageFile="~masterurl/default.master" %>
<%@ Register src="~/_controltemplates/BIT.UDLA.FLUJO.PASANTIAS.WebParts/usrCancelarPractica.ascx" tagname="usrCancelar" tagprefix="uc1" %>
...
<uc1:usrCancelar ID="editarUsrCancelar" runat="server" OnAceptar="Aceptar" OnCancelar="Cancelar" />
</asp:Content>
